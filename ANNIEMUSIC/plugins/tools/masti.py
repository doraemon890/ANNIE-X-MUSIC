...
async def HORNY(_, message):
    ...
    await message.reply_video(HORNY, reply_markup=BUTTON, )
...
async def HOT(_, message):
    ...
    await message.reply_video(HOT, reply_markup=BUTTON, )
...
async def SEMXY(_, message):
    ...
    await message.reply_video(SEMXY, reply_markup=BUTTON, )
...
async def GAY(_, message):
    ...
    await message.reply_video(GAY, reply_markup=BUTTON, )
...
async def LEZBIAN(_, message):
    ...
    await message.reply_video(LEZBIAN, reply_markup=BUTTON, )
...
async def BIGBALL(_, message):
    ...
    await message.reply_video(BIGBALL, reply_markup=BUTTON, )
...
async def LANGD(_, message):
    ...
    await message.reply_video(LANGD, reply_markup=BUTTON, )
...
async def CUTIE(_, message):
    ...
    await message.reply_video(CUTIE, reply_markup=BUTTON, )
