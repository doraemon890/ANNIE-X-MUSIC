...
async def HORNY(_, message):
    ...
    await message.reply_txt(HORNY, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
...
async def HOT(_, message):
    ...
    await message.reply_txt(HOT, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
...
async def SEMXY(_, message):
    ...
    await message.reply_txt(SEMXY, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
...
async def GAY(_, message):
    ...
    await message.reply_txt(GAY, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
...
async def LEZBIAN(_, message):
    ...
    await message.reply_txt(LEZBIAN, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
...
async def BIGBALL(_, message):
    ...
    await message.reply_txt(BIGBALL, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
...
async def LANGD(_, message):
    ...
    await message.reply_txt(LANGD, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
...
async def CUTIE(_, message):
    ...
    await message.reply_txt(CUTIE, reply_markup=BUTTON, disable_web_page_preview=True, quote=True)
