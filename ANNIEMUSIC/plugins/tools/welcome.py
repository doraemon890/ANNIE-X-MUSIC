...
def welcomepic(pic, user, chatname, id, uname):
    ...
    draw.text((1849, 1049), f': {user}', fill=(238, 174, 209), font=font)
    draw.text((1601, 1265), f': {id}', fill=(238, 174, 209), font=font)
    draw.text((2065, 1485), f": {uname}", fill=(238, 174, 209), font=font)
