...
LOGGER_ID = int(getenv("LOGGER_ID", -1002047901930))
DURATION_LIMIT_MIN = int(getenv("DURATION_LIMIT", 17000))
# External APIs - Get these from their respective providers
GPT_API = getenv("GPT_API")
PLAYHT_API = getenv("PLAYHT_API")
OWNER_ID = int(getenv("OWNER_ID", 6755508094))
...
GIT_TOKEN = getenv("GIT_TOKEN", "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")
