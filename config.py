...
# Dictionary for storing lyrics
lyrical = {}

# Dictionary for vote mode
votemode = {}

# List for autoclean
autoclean = []

# Dictionary for confirmation messages
confirmer = {}
